...
const CourseDetailsSidebar = ({ course,details_2=false }) => {
    ...
    const handleOnClick = async()=>{
        ...
        if(user){
            const query = ref(database,`users/${user.uid}/${course?.id}`)
            return onValue(query,(snapshot)=>{
              ...
              if(snapshot.exists()){
                ...
                toast.error("Please Purchase This Course");
              }
            })
        }
        else{
                ...
                <div className="edu-course-widget widget-course-summery">
                    <div className="inner">
                        <div className="thumbnail">
                            <img src={`/assets/images/course/${img}`} alt="Course Thumb" />
                            <a onClick={handleOnClick} style={{ cursor: 'pointer' }} className="play-btn video-popup-activation">
